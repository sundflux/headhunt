...
void HEADHUNT_checkTag( Entity @target, Entity @attacker, Entity @inflicter )
{
    ...
    {
        HEADHUNT_tagPlayer( target , attacker, inflicter );
    }
    else
    {
...
void HEADHUNT_tagPlayer( Entity @target, Entity @attacker, Entity @inflicter )
{
    ...
    target.client.inventoryGiveItem(WEAP_GUNBLADE);
...
void HEADHUNT_playerKilled( Entity @target, Entity @attacker, Entity @inflicter )
{
    ...
    if ( @attacker != null && @attacker.client != null )
    {
        if (target.client.playerNum == hhTaggedPlayer && attacker.client.playerNum != target.client.playerNum)
        {
            ...
            if ( autoTag == 1 )
            {
                ...
                attacker.client.inventoryGiveItem(WEAP_GUNBLADE);
...
{
    gametype.title = "Headhunt Deathmatch";
    ...
    G_ConfigString( CS_SCB_PLAYERTAB_LAYOUT, "%n 112 %s 52 %i 52 %s 52 %l 48 %p 18 %p 18" );
    G_ConfigString( CS_SCB_PLAYERTAB_TITLES, "Name Clan Score Tagtime Ping C R" );
